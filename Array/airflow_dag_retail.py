...
yaml_path = cicd_bucket_name + "/rtd/dags/config/basel_controller_retail_dag_util.yaml"
...
###############################################################
airflow_dag_name = 'rtd_basel_controller_retail'
root_folder = ''
...
status_output_path = CONFIG_DICT['status_output_path'] + 'rtd_basel_contoller_reatil_status' + RUN_ID
run_type_dict = CONFIG_DICT['run_type']
section_list_retail = CONFIG_DICT['run_type']['RET']
#section_list_retail_crm = CONFIG_DICT['run_type']['RET_CRM']
...
def final_status(run_type_dict, **kwargs):
    ...
    file_path = status_output_path + '/rtd_controller_retail_end_status.json'
...
set_run_rk = BashOperator(task_id='set_run_rk',
                          bash_command=(f"""{ssh_cmd} spark-submit -v --master=yarn --driver-memory=19g \
                                            ...
                                            {emr_file_path}Retail_run_rk.py --etl_param_table {etl_param_table}"""
...
#ret_post_crm_wait_dag.set_downstream(ret_post_calc_dag)
